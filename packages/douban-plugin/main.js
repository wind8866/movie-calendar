...
async function pullDouId() {
  const res = await fetch(
    'https://movie-data.oss-cn-hongkong.aliyuncs.com/latest-data/douTo-zlg-mapping.json',
  )
  console.log(res)
  return res.json()
}
async function pullMovieInfoMap() {
  const res = await fetch(
    'https://movie-data.oss-cn-hongkong.aliyuncs.com/latest-data/movie-list-map.json',
  )
  console.log(res)
  return res.json()
}
